...
const Errors = require("../api/errors/pilot-logbook-error.js");
...
const logger = LoggerFactory.get("PilotLogbookAbl");

class PilotLogbookAbl {
  constructor() {
...
module.exports = new PilotLogbookAbl();
