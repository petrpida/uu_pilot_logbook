...
describe(`UuPilotLogbook.Core.Aircraft.AircraftObjectProvider`, () => {
  // it("onLoad", async () => {
  //   let onLoad = jest.fn(async () => ({ content: "Hello, world!" }));
  //   let loadDtoIn = { foo: "bar" };
  //   let wrapper = mount(<UuPilotLogbook.Core.Aircraft.AircraftObjectProvider onLoad={onLoad} loadDtoIn={loadDtoIn} />);
